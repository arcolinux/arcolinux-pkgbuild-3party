...
makepkglist="bash-pipes bibata-cursor-theme betterlockscreen caffeine-ng cava cmatrix-git  conky-lua-archers dbus-go dwm font-manager-git gnome-shell-extension-pop-shell-git \
 gksu hw-probe libgksu lxqt-arc-dark-theme-git obmenu-generator mintlocale tauon-music-box megasync-nopdfium \
 mintstick-git numix-kde-theme-git numix-circle-arc-icons-git numix-circle-icon-theme-git octopi optimus-manager-qt perl-checkupdates-aur pamac-all \
 perl-checkupdates-aur pamac-aur pop-shell-shortcuts-git timeshift-autosnap python2-notify python-protobuf radiotray screenkey-git sutils-git systemd-manager \
 surfn-mint-y-icons-git steam-buddy steam-tweaks theme.sh-git warpinator xdgmenumaker xmonad-log \
 yin-yang-git fvwm3-git powerpill python3-xcpf pm2ml"
